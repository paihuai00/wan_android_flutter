...
typedef ProjectCardViewWidgetCallBack = Function(
    ProjectDetailItem projectDetailItem);

class ProjectCardViewWidget extends StatefulWidget {
  ProjectDetailItem projectDetailItem;

  ProjectCardViewWidgetCallBack? callBack;

  ProjectCardViewWidget(this.projectDetailItem, {Key? key, this.callBack})
      : super(key: key);

  @override
  _ProjectCardViewWidgetState createState() => _ProjectCardViewWidgetState();
}

class _ProjectCardViewWidgetState extends State<ProjectCardViewWidget> {
